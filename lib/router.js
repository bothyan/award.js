...
export class Router extends React.Component {
    ...
    componentWillReceiveProps() {
        const { query } = ResolveRouter(this.context.SWRN_PROPS.data.routes, location.pathname)
        this.setState({
            query
        })
    }
    ...
    render() {
        ...
        let _Component = [], SWRN_PROPS, route, query, Component
        const contextSwrn_Props = this.context.SWRN_PROPS
        ...
        if (isInServer()) {                        
            ...
            SWRN_PROPS = Object.assign({}, contextSwrn_Props)
            ...
            SWRN_PROPS = Object.assign({}, contextSwrn_Props.data)            
        }
...
export class Link extends React.Component {
    ...
    async onClick() {
        ...
        let { routes, assetPrefix } = this.context.SWRN_PROPS.data
        const { routeLoader } = this.context.SWRN_PROPS
        const { to } = this.props
